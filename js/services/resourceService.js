four51.app.factory('Resources', function() {
    ...
    var logoSpecs = {
		...
		"BDP_DefensaDesign_Green": urlPath + 'DefensaDesign/DefensaDesign-cmyk-376.pdf',
		"BDP_DefensaDesign_CMYK": urlPath + 'DefensaDesign/DefensaDesign-cmyk-376.pdf',
		"BDP_DefensaDesign_White": urlPath + 'DefensaDesign/DefensaDesign-white.pdf',
		"BDP_DefensaDesign_Black": urlPath + 'DefensaDesign/DefensaDesign-black.pdf',
		"BDP_DefensaBasic_CMYK": urlPath + 'DefensaBasic/DefensaBasic-cmyk-376.pdf',
		"BDP_DefensaBasic_Green": urlPath + 'DefensaBasic/DefensaBasic-cmyk-376.pdf',
		"BDP_DefensaBasic_White": urlPath + 'DefensaBasic/DefensaBasic-white.pdf',
		"BDP_DefensaBasic_Black": urlPath + 'DefensaBasic/DefensaBasic-black.pdf',
		"BDP_DefensaPremium_Green": urlPath + 'DefensaPremium/DefensaPremium-cmyk-376.pdf',
		"BDP_DefensaPremium_CMYK": urlPath + 'DefensaPremium/DefensaPremium-cmyk-376.pdf',
		"BDP_DefensaPremium_White": urlPath + 'DefensaPremium/DefensaPremium-white.pdf',
		"BDP_DefensaPremium_Black": urlPath + 'DefensaPremium/DefensaPremium-black.pdf',
		"BDP_DefensaSecurityGate_Green": urlPath + 'DefensaSecurityGate/DefensaSecurityGate-cmyk-376.pdf',
		"BDP_DefensaSecurityGate_CMYK": urlPath + 'DefensaSecurityGate/DefensaSecurityGate-cmyk-376.pdf',
		"BDP_DefensaSecurityGate_White": urlPath + 'DefensaSecurityGate/DefensaSecurityGate-white.pdf',
		"BDP_DefensaSecurityGate_Black": urlPath + 'DefensaSecurityGate/DefensaSecurityGate-black.pdf',
		"BDP_DefensaTrue_Green": urlPath + 'DefensaTrue/DefensaTrue-cmyk-376.pdf',
		"BDP_DefensaTrue_CMYK": urlPath + 'DefensaTrue/DefensaTrue-cmyk-376.pdf',
		"BDP_DefensaTrue_White": urlPath + 'DefensaTrue/DefensaTrue-white.pdf',
		"BDP_DefensaTrue_Black": urlPath + 'DefensaTrue/DefensaTrue-black.pdf',
		"BDP_DefensaSecurityPapers_White": urlPath + 'DefensaSecurityPapers/DefensaSecurityPapers-white.pdf',
		"BDP_DefensaSecurityPapers_CMYK": urlPath + 'DefensaSecurityPapers/DefensaSecurityPapers-cmyk.pdf',
		"BDP_DefensaSecurityPapers_Spot": urlPath + 'DefensaSecurityPapers/DefensaSecurityPapers-spot.pdf',
		"BDP_DefensaSecurityPapers_Black": urlPath + 'DefensaSecurityPapers/DefensaSecurityPapers-black.pdf',
		"BDP_DefensaSecurityPapers_Green": urlPath + 'DefensaSecurityPapers/DefensaSecurityPapers-cmyk-376.pdf',
		...
		"BDP_NatureSolv_Black": urlPath + 'NatureSolv/NatureSolv-cmyk.pdf',
		"BDP_NatureSolv_CMYK_White": urlPath + 'NatureSolv/NatureSolv-white.pdf',
		"BDP_NatureSolv_CMYK": urlPath + 'NatureSolv/NatureSolv-cmyk-white.pdf',
		"BDP_NatureSolv_Spot": urlPath + 'NatureSolv/NatureSolv-cmyk.pdf',
		"BDP_NatureSolv_White": urlPath + 'NatureSolv/NatureSolv-spot.pdf',
		"BDP_Sequel_White": urlPath + 'Sequel/Sequel-white.pdf',
		"BDP_Sequel_CMYK": urlPath + 'Sequel/Sequel-cmyk.pdf',
		"BDP_Sequel_Spot": urlPath + 'Sequel/Sequel-spot.pdf',
		"BDP_Sequel_Black": urlPath + 'Sequel/Sequel-black.pdf'
    };
